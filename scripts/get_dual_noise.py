...
if __name__ == "__main__":
    ...
    parser.add_argument('--freq', '-fa', help='LO frequency in MHz', type=float, default= 300)
    parser.add_argument('--freq', '-fb', help='LO frequency in MHz', type=float, default= 300)

    parser.add_argument('--gain_A', '-ga', help='TX noise', type=int, default= 0)
    parser.add_argument('--gain_B', '-gb', help='TX noise', type=int, default= 0)
