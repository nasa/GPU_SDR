...
SRC = USRP_server_console_print.cpp usrp_server.cpp USRP_file_writer.cpp USRP_server_link_threads.cpp USRP_hardware_manager.cpp USRP_demodulator.cpp USRP_server_network.cpp USRP_server_memory_management.cpp USRP_server_diagnostic.cpp USRP_JSON_interpreter.cpp USRP_buffer_generator.cpp

usrp_server: kernels.o
	#$(SRC)
	$(CC) $(CLINK) $(CFLAGS) $(CINCLUDE) $(NVINCLUDE) -L/usr/local/cuda/lib64 -o usrp_server usrp_server.cpp kernels.o 
