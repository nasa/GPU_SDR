...
NVLINK =  -L/usr/local/cuda/lib64 -lcudart -lcuda  -lcufft -lcublas -lculibos
...
#kernels.o: kernels.cuh kernels.cu kernels_unlinked.o
#	$(NVCC) $(NVINCLUDE) -rdc=false -dlink -o kernels.o kernels_unlinked.o $(NVLINK)
